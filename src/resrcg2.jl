...
# Solves for x
function resrcg2!(A, b::Vector{T}, x::Vector{T}, d, term::Float64;
             maxIter::Int64=200,
             precon=copy!,
    ...
    for iter = 1:maxIter
        weight = 1 / ccdf(d, log(1 / (1 -sum_res)))
        # println(weight)
        A(data.Ap, data.p)
...
function resrcr!(A, b::Vector{T}, x::Vector{T}, d, term::Float64;
    maxIter::Int64=200,
...
export CGData, CGData2, resrcg2!, resrcr!